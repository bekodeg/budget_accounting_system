...
void main() {
  ...
  test('lists only accounts from requested budget in stable order', () async {
    await createAccount(id: 'b', budgetId: 'budget-1', openingBalanceMinor: 0);
    await createAccount(id: 'a', budgetId: 'budget-1', openingBalanceMinor: 0);
    await createAccount(
      id: 'foreign',
      budgetId: 'budget-2',
  ...
  test(
    'balance includes opening income expense and transfer directions',
    () async {
      await createAccount(
        id: 'source',
        budgetId: 'budget-1',
  ...
  test(
    'archive hides account from active list but preserves transaction',
    () async {
      await createAccount(
        id: 'account-1',
        budgetId: 'budget-1',
